...
void Init_Green_Led() {
	...
	PTD->PDOR |= 1u<<5; //Dat gia tri khoi tao la bat den
};

void Toogle_Green_Led(uint16_t time) {
...
void Init_Red_Led() {
	...
	PTE->PDOR |= 1u<<29; // Dat gia tri khoi tao la bat den
}

void Toogle_Red_Led(uint16_t time) {
